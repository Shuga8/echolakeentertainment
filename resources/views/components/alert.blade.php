@if (session('success'))
	<div
		class="max-w-72 fixed right-5 top-24 z-30 mb-4 flex w-full items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
